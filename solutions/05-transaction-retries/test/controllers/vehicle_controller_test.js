...
describe('Vehicle Controller', () => {
  ...
  describe('updateVehicle', () => {
    ...
    it('should save the updated vehicle in the repository and return the result.', async () => {
      ...
      repository.updateVehicle = async (id, up) => {
        id.should.equal(originalVehicle.id);
        up.should.eql(update);
      ...
      result.should.eql(updatedVehicle);
    });
  });
});
